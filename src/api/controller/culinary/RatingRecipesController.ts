...
export class RatingRecipesController {
  router = Router();
  ratingGetAll = container.resolve<IRatingGetAll>("IRatingRecipesGetAll");
  ratingGetById = container.resolve<IRatingGetById>("IRatingRecipesGetById");
  ratingCreate = container.resolve<IRatingCreate>("IRatingRecipesCreate");
  ratingUpdate = container.resolve<IRatingUpdate>("IRatingRecipesUpdate");
  ratingDelete = container.resolve<IRatingDelete>("IRatingRecipesDelete");
